...
export default function Disclaimer() {
  return (
    <div className="d-flex justify-content-center align-items-center p-5" style={{ backgroundColor: '#f9f9f9' }}>
      <div className="container-lg text-center p-0">
        <h4 className="text-dark display-4 fw-medium mb-2">DISCLAIMER</h4>
        <p className="mb-3">
          <p className='fs-4 fw-semibold'>This is a personal project intended for educational and non-commercial purposes only.</p>
        </p>
        <ul className="list-unstyled">
          <li className="fw-medium mb-2">
