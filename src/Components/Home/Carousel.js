                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-flex flex-column justify-content-center align-items-start" style={{ top: '50%', transform: 'translateY(-50%)', left: '10%', textAlign: 'left', maxWidth: '500px' }}>
                            ...
                            <div>
                                <button className="btn custom-button-default-transparent btn-lg me-3">
                                    <Link to='/Courses' className="nav-link">Explore certificates</Link>
                                </button>
                                <button className="btn custom-button-default-white-transparent btn-lg custom-join-btn" onClick={handleOnSignUp}>Join for free</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-flex flex-column justify-content-center align-items-start" style={{ top: '50%', transform: 'translateY(-50%)', left: '10%', textAlign: 'left', maxWidth: '500px' }}>
                            ...
                            <div>
                                ...
                                <button className="btn custom-button-default-white-transparent btn-lg custom-join-btn" onClick={handleOnSignUp}><Link to='/Courses' className="nav-link">Discover more</Link></button>
                            </div>
                        </div>
                    </div>
