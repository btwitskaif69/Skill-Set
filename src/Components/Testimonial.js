...
const Testimonial = forwardRef((props, ref) => {
  ...
  return (
    <div
      ...
      style={{ padding: '2rem 3rem', margin: '2rem 0rem' }}
    >
      <div className="row mb-8 justify-content-center">
        <div className="col-lg-8 col-md-12 col-12 text-center">
          <span
            className="testimonial-heading mb-1 d-block text-uppercase fw-semibold fs-4"
            style={{ color: '#210BE3' }}
          >
            Testimonials
          </span>
          <h2
            className="testimonial-title mb-1 display-4 fw-semibold"
            style={{ color: 'black' }}
          >
            What our learners are saying
          </h2>
          <p className="testimonial-subtitle fs-5 mb-1" style={{ color: 'black' }}>
            1+ million people are already learning on Skill Set
          </p>
        </div>
      </div>
        ...
        <div className="col-md-12">
          <Slider ref={sliderRef} {...settings}>
            {testimonials.map((testimonial) => (
              <div
                className="testimonial-item px-0"
                key={testimonial.id}
              ...
              >
                <div className="testimonial-card border p-4 rounded my-4 mx-4 rounded-3 mx-1">
                  ...
                  >
                    <p
                      className="testimonial-text lead text-dark fs-6 fw-medium"
                      style={{
                        maxHeight: '150px',
                        overflow: 'hidden',
                  ...
                  <div className="testimonial-card-footer d-flex align-items-center pt-2 border-0">
                    ...
                    />
                    <div>
                      <h5 className="testimonial-name mb-0 fw-bold" style={{ color: 'black' }}>
                        {testimonial.name}
                      </h5>
                      <p className="testimonial-role mb-0 small text-muted">
                        {testimonial.role}
                      </p>
                    </div>
                  </div>
          ...
          <div className="d-flex justify-content-center">
            <button onClick={previous} className="btn btn-light rounded-circle mt-1 mx-2">
              <i className="bi bi-chevron-left"></i>
            </button>
            <button onClick={next} className="btn btn-light rounded-circle mt-1 mx-2">
