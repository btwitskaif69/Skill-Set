...
const Testimonial = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref} className="testimonial-container p-4">
      <div className="justify-content-center">
        <div className="text-center">
          <span className="testimonial-heading text-uppercase fw-semibold fs-4  mb-1" style={{ color: "#210BE3" }}>Testimonials</span>
              ...
              <div className="testimonial-item" key={testimonial.id}>
                <div className="testimonial-card border p-4 mb-4 rounded mx-4 mt-4 rounded-3">
                  ...
                  <div className="testimonial-card-body">
                    <p className="testimonial-text lead text-dark fs-6 fw-medium mb-4">"{testimonial.text}"</p>
                  </div>

                  <div className="testimonial-card-footer d-flex align-items-center border-0">
